...
class MyApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) { // context содержит meta информацию о 
                                       // виджете и его положении в дереве
                                       // виджетов. Любой виджет может содержать
                                       // в себе другие виджеты.
      return MaterialApp( // MaterialApp() является основой для построения при
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold( // Scaffold() - это виджет, кото
      ...
      appBar: AppBar( // appBar - задает строчку вверху.
        title: Text('Тестирование'),
      ),
      body: Container( // body - это тело нашего приложения. Container() -
                           // это по большей части оформительский блок, аналог
                           // div в web, может принимать границы, размеры,
                           // отступы и т.д. 
        child: Center( // child - продолжает Container().
